    ...
    begin
        ...
        WITH CuadroComisiones DO BEGIN
            ...
            REPEAT
                ...
                CASE x OF
                    0:
                        SETRANGE("Valor Venta", SalesLine."Sell-to Customer No.");
                    1:
                        SETRANGE("Valor Venta", SalesLine."Gen. Bus. Posting Group");
                    2:
                        SETRANGE("Valor Venta", '');
                END;
                ...
                */
                IF (NOT encontrado) AND (SalesLine."Item Category Code" <> '') THEN BEGIN
                    ...
                    IF FINDLAST THEN BEGIN
                        ...
                        encontrado := TRUE;
                    END ELSE
                        SETRANGE("Cód. Categoria producto");
                END;
                x += 1;

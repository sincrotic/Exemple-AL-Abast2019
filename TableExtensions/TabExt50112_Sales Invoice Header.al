...
tableextension 50112 SalesInvocieHeaderExt extends "Sales Invoice Header"
{
    fields
    {
        //-HEB.244
        ...
        field(50013; "Importe Comisiones"; Decimal) //-114: PI0010
        {
            ...
            CalcFormula = sum("Sales Invoice Line"."Importe Comisión" where ("Document No."=field("No."),Type=FIELD("Filtro Tipo Linea")));

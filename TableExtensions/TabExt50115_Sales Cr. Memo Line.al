tableextension 50115 SalesCrMemoLineExt extends "Sales Cr.Memo Line"//MyTargetTableId
{
    fields
    {
        ...
        Field(50022; "Bill-to Name"; Text[50]) //-247
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = Lookup("Sales Cr.Memo Header"."Bill-to Name" WHERE ("No."=FIELD("Document No.")));            
        }
        //+HEB.247
        //-HEB.247
        Field(50023; "Bill-to Country/Region Code"; Code[10]) //-247
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = Lookup("Sales Cr.Memo Header"."Bill-to Country/Region Code" WHERE ("No."=FIELD("Document No.")));            
        }
        //+HEB.247
        //-HEB.247

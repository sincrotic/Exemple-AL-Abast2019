page 50031 "Líneas Pdtes. Facturar (V-DDP)"
{
    //VersionList AITANA
    ...
    SourceTableView = SORTING("Document Type","Document No.","Line No.") ORDER(Ascending) WHERE("Document Type"=CONST(Order), "Qty. Shipped Not Invoiced"=FILTER(>0), "Purchasing Code"=CONST('DDP'));
